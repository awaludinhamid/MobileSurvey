  ...
  <div class="modal fade modal-two-columns" id="mdl-save-record" tabindex="-1" role="dialog" aria-labelledby="save-record-title" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form:form id="form-save" class="form-horizontal" modelAttribute="company" method="POST" enctype="multipart/form-data">
            <form:hidden path="coyId" id="coyId"/>
            <form:hidden path="createdBy" id="createdBy"/>
            <form:hidden path="detailCompanyLogo.companyLogoId" id="companyLogoId"/>
            <div class="form-group">
              <label class="col-sm-2 control-label">Company Code*</label>
              <div class="col-sm-4">
                <form:input path="coyCode" id="coyCode" class="form-control input-required" placeholder="[SIM001]" maxlength="20" tabindex="1"/>
              </div>
              <label class="col-sm-2 control-label">Number of Users*</label>
              <div class="col-sm-4">
                <form:input type="number" path="noOfUsers" id="noOfUsers" class="form-control input-required" placeholder="[100]" tabindex="10"/>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Company Name*</label>
              <div class="col-sm-4">
                <form:input path="coyName" id="coyName" class="form-control input-required" placeholder="[PT SWAKARSA INSAN MANDIRI]" maxlength="100" tabindex="2"/>
              </div>
              <label class="col-sm-2 control-label">System Name</label>
              <div class="col-sm-4">
                <form:input path="systemName" id="systemName" class="form-control" placeholder="[Mobile Survey]" maxlength="30" tabindex="11"/>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Address</label>
              <div class="col-sm-4">
                <form:textarea path="address" id="address" class="form-control" placeholder="[Jl Kebagusan]" maxlength="120" tabindex="3"></form:textarea>
              </div>
              ...
              <div class="col-sm-4">
                <div class="input-group">
                  ...
                  <input type="text" id="fileNameTmp" class="form-control" readonly>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <form:input path="phone" id="phone" class="form-control" placeholder="[021-777888999]" maxlength="20" tabindex="4"/>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">MOU No.</label>
              <div class="col-sm-4">
                <form:input path="mouNo" id="mouNo" class="form-control" placeholder="[SIM001-20161023]" maxlength="30" tabindex="5"/>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <form:input path="picName" id="picName" class="form-control" placeholder="[Bambang Utoyo]" maxlength="30" tabindex="8"/>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">HP No.</label>
              <div class="col-sm-4">
                <form:input path="hpNo" id="hpNo" class="form-control" placeholder="[0811-999888777]" maxlength="30" tabindex="9"/>
              </div>
            </div>
