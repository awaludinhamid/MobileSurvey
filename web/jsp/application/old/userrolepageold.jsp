        ...
        <table id="tbl-data" class="table table-bordered table-condensed">
          ...
          <tbody>
            <tr ng-repeat="data in datatable" data-id="{{data.userRoleId}}">
              ...
              <td>
                <img id="img-menu-record" class="img-record img-record-small" src="../../img/icon/menu-icon.png" alt="Menu icon" title="Detail"/>
              </td>
        ...
        <div class="modal-body">
          <form id="form-save" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select id="officeId" class="form-control display-only" tabindex="1">
                  <option ng-repeat="dropsave in datadrop.office" value="{{dropsave.officeId}}">{{dropsave.officeName}}</option>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select id="userId" class="form-control" tabindex="2">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input id="userName" class="form-control input-required display-only" readonly>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Role</label>
              <div class="col-sm-8" style="height: 100px; overflow-y: auto" id="roles">
                <div class="input-group" ng-repeat="drop in datadrop.role" data-id="{{drop.roleId}}">
                  <span class="input-group-addon">
                      <input type="checkbox" class="display-only">
                  </span>
                  <span class="form-control">{{drop.roleName}}</span>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <div class="input-group">
                  <input id="startDate" class="form-control input-required" placeholder="[yyyy-mm-dd]" pattern="^(19|20)\d\d[- /.](0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])$" title="(yyyy-mm-dd)" tabindex="8">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <div class="input-group">
                  <input id="endDate" class="form-control input-required" placeholder="[yyyy-mm-dd]" pattern="^(19|20)\d\d[- /.](0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01])$" title="(yyyy-mm-dd)" tabindex="9">
                  <div class="input-group-btn">
