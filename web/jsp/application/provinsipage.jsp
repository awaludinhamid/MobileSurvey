...
<html>
  <head>
    <!--script src="../../js/application/provinsi.js"></script--> 
    <script>
...
<body>
  <div id="provinsi" class="target-div" hidden>
  <div id="page-content-wrapper">
    <div class="container">
      <div class="find-record form-group">
        <div class="col-sm-3">
          <input class="form-control" placeholder="Provinsi Code" ng-model="provCodePattern" ng-init="provCodePattern=''">
        </div>
        <div class="col-sm-3">
          <input class="form-control" placeholder="Provinsi Name" ng-model="provNamePattern" ng-init="provNamePattern=''">
        </div>
      </div>
      <div id="div-table" class="table-container">
        <table id="tbl-data" class="table table-bordered table-condensed">
          ...
          <tbody>
            <tr ng-repeat="data in datatable" data-id="{{data.provId}}">
              <td>
        ...
        <div class="modal-body">
          <form id="form-save" class="form-horizontal">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Provinsi Code*</label>
              <div class="col-sm-9">
                <input id="provCode" class="form-control" placeholder="[001]" maxlength="20" tabindex="1" required autofocus>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-3 control-label">Provinsi Name*</label>
              <div class="col-sm-9">
                <input id="provName" class="form-control" placeholder="[DKI Jakarta]" maxlength="100" tabindex="2" required>
              </div>
            </div>
            <div class="form-group">
